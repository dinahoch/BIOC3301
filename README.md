...
summarize_taxa_through_plots.py -i filtered_taxa.biom -o taxa_summary -m map.tsv_corrected.txt
# compare phyla frequencies in both years to determine whether differences are statistically significant
group_significance.py -i filtered_taxa_L2.biom -m map.tsv_corrected.txt -c Year -o nonpara_tt.txt -s nonparametric_t_test
